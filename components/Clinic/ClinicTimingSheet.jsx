          ...
          >
            <Surface className="rounded-3xl bg-white-100 overflow-hidden shadow-md">
              <View className="flex-row justify-between items-center p-4 border-b border-gray-200 bg-white-200">
                <Text className="text-lg font-pbold text-black-400">Clinic Hours</Text>
                <TouchableOpacity
                  onPress={onDismiss}
                  className="p-1"
                >
              ...
              {open24hrs ? (
                <View className="p-8 items-center justify-center">
                  ...
                  <Text className="text-2xl font-pbold text-secondary-300 mt-4">Open 24 Hours</Text>
                    ...
                    return (
                      <MotiView
                        ...
                        className={`flex-row justify-between items-center py-3 border-b border-gray-100 mb-1 ${
                          isToday ? "bg-secondary-100/30 rounded-lg px-2 my-1" : ""
                        }`}
                      >
                        <View className="flex-row items-center">
                          {isToday && <View className="w-2 h-2 rounded-full bg-secondary-300 mr-2" />}
                          <Text
                            className={`text-base ${
                              isToday ? "font-ossemibold text-secondary-300" : "font-ossemibold text-black-300"
                            }`}
                          >
